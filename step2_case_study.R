...
##############################################################################################################################
###########################<<3>> Dividing cells into different developmental stages ##########################################
##############################################################################################################################
# [1]GW16 to GW23.5
...
cell_development_number <- 5 # 5 development stages
...
for (i in 1:cell_development_number){
...
## downstream [8] The cell type-specific lncRNAs analysis
  ...
  CSlncR_pvalue <- function(tmp,cell_development_number) {
    res_pvalue <- matrix(NA, nrow = cell_development_number, ncol = cell_development_number)
    for (i in seq(cell_development_number)) {
      for (j in seq(cell_development_number)) {
    ...
    res_predict_pvalue <- CSlncR_pvalue(tmp= CSlncR_network_lncRcelltype,cell_development_number=cell_development_number) 
    res_ASD_pvalue <- CSlncR_pvalue(tmp= CSlncR_network_lncRcelltype_ASD,cell_development_number=cell_development_number) 

    rownames(res_predict_pvalue) <- colnames(res_predict_pvalue) <- paste("Cell_development",c(1:cell_development_number),sep=" ")
    rownames(res_ASD_pvalue) <- colnames(res_ASD_pvalue) <- paste("Cell_development",c(1:cell_development_number),sep=" ")
    test.value <- matrix(0, nrow = cell_development_number, ncol = cell_development_number)
...
col1 <- rep("#FF9999", cell_development_number)
...
col2 <- rep("plum4", cell_development_number)
...
col3 <- rep("blue", cell_development_number)
...
col4 <- rep("green", cell_development_number)
...
data1$Methods <- c(rep("CDSlncR",cell_development_number), rep("CDSlncR without prior knowledge",cell_development_number))
data2 <- rbind(index_validated_net,index_validated_net_random)
data2$Methods <- c(rep("CDSlncR",cell_development_number), rep("Random",cell_development_number))
data3 <- rbind(index_validated_net,index_validated_net_LncRNA2Target)
data3$Methods <- c(rep("CDSlncR",cell_development_number), rep("LncRNA2Target",cell_development_number))
data4 <- rbind(index_validated_net,index_validated_net_NPInterPrediction)
data4$Methods <- c(rep("CDSlncR",cell_development_number), rep("NPInterPrediction",cell_development_number))
